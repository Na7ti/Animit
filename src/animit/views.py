...
from .models import AnimitUser,Animal
...
class SignUp_Base(TemplateView):
    """サインイン時の最初のページ"""
    def __init__(self):
        self.template_name = 'animit/sign_up/base.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if self.params["form"].is_valid():
            ...
            return HttpResponseRedirect(reverse("animit:sign_up_certification"))
...
class SignUp_Certification(TemplateView):
    """サインイン時の2段階認証ページ"""
    def __init__(self):
        self.template_name = 'animit/sign_up/certification.html'
        self.params = {
            "form": UserForm(sign_up=True),
        ...
        if self.params["form"].is_valid():
            ...
            if sign_up_data["authentication_code"] == request.POST['authentication_code']:
                # 認証成功
                    ...
                    return HttpResponseRedirect(reverse("animit:sign_up_set_animal"))
            else:
...
class SignUp_SetAnimal(TemplateView):
    """動物を選択するページ"""
    def __init__(self):
        self.template_name = 'animit/sign_up/set_animal.html'
        self.params = {
            "form": UserForm(sign_up=True),
            # "fields": ["authentication_code"] # 表示するフィールド
        }
...
class Login(TemplateView):
    def __init__(self):
        self.template_name = 'animit/login.html'
...
class LogOut(TemplateView):
    ...
    def get(self, request):
        logout(request)
        return HttpResponseRedirect(reverse("animit:sign_up"))

class Home(LoginRequiredMixin, TemplateView):
    def __init__(self, **kwargs: Any) -> None:
        self.template_name = "animit/home.html"
